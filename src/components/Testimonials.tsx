...
export function Testimonials() {
  return (
    <div class="bg-red-900 p-4 my-4">
      <section class="max-w-7xl mx-auto flex flex-col gap-6 items-center p-8  w-full h-full">
        <h2 class="text-5xl font-normal text-white text-center mb-2">
          Testimonios
        </h2>
        <p class="text-xl font-light text-slate-200 text-center max-w-2xl">
          Lo que nuestros clientes dicen sobre nosotros.
        </p>
        <div class="max-w-5xl grid grid-cols-4 gap-4 py-4">
